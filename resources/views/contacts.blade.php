            ...
            <div class="row row-contacts-page-contacts-list justify-content-between sm-gutters pt-20">
                    ...
                    <div class="mb-20">
                        ...
                        <div class="row sm-gutters align-items-center mt-5">
                            <div class="col-auto _h6 bold col">
                                <a class="block nul color-black"><span class="dashed dash">+375 (44) 725-75-75</span></a>
                            </div>
                            <div class="col-auto col">
                                <a href="" class="social-colored-icon__link colored tg">
                            ...
                            <div class="col-auto col">
                                <a href="" class="social-colored-icon__link colored vi">
                            ...
                            <div class="col-auto col">
                                <a href="" class="social-colored-icon__link colored wh">
                        ...
                        <div class="_h6 bold mt-5"><a href="" class="color-black nul"><span class="dashed dash">+375 (17) 203-71-09</span></a></div>
                        <div class="_h6 bold mt-5"><a href="" class="color-black nul"><span class="dashed dash">+375 (17) 203-76-25</span></a></div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-5 col-md-12 col-12 col pb-15 order-lg-2 order-3">
                    <div class="mb-20">
                        ...
                        <div class="_h6 semibold mb-10">г.Минск, Меньковский тракт 2, офис 45</div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-5 col-12 col pb-15 order-lg-3 order-2">
                    <div class="mb-20">
                        ...
                        <div class="_h6 mt-5"><a href="" class="color-orange semibold nul"><span class="dashed dash">info@perf.by</span></a></div>
                    </div>
                    <div class="mb-20 col-lg-show">
                        <div class="mb-10 color-orange">Мы в соц. сетях</div>
                        <div class="row sm-gutters mt-5">
                            <div class="col-auto">
                                <a href="" class="white-social-icon__link gray fcm">
                                    <img src="assets/i/ig-colored-icon.svg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 order-5">
                    <div class="mb-20">
                        ...
                        <div class="_h6 semibold mb-10">ООО perf.by (продажа электро и бензоинструментов, оборудование) 220004, Республика Беларусь, г. Минск, ул. Кальварийская, 1-1, каб. 408 Расчетный счет (BYN): BY20PJCB30120257941000000933 «Приорбанк» ОАО, ЦБУ 102, БИК PJCBBY2X УНП 191781387, ОКПО 380437565000 Директор - Кеда Александр Николаевич, действует на основании Устава</div>
                    </div>
                </div>
            </div>
        </div>
