        ...
        <div class="row row-h-mobile align-items-center justify-content-between">
            ...
            <div class="col-right col col-auto">
                <div class="row lg-lg-gutters md-md-gutters sm-sm-gutters xxxs-no-gutters align-items-center justify-content-end">
                    ...
                    <div class="col-auto">
                        <a href="" class="mobile-btn__link fcm cart _active">
                            ...
                            <div class="parent">
                                ...
                                <div class="inset _js-inset">
                                    <div class="frame">
                                        ...
                                        <div class="pt-10">
                                            <div class="row align-items-center sm-gutters">
                                                <div class="col-auto col">
                                                    <a href="" class="color-black nul semibold"><span class="dashed dash">+375 (29) 237-07-97</span></a>
                                                </div>
                                                <div class="col-auto col">
                                        ...
                                        <div class="pt-10">
                                            <div class="color-gray semibold">Подпись для телефона 1</div>
                                            <div class="row align-items-center sm-gutters">
                                                <div class="col-auto col">
                                                    <a href="" class="color-black nul semibold"><span class="dashed dash">+375 (29) 123-07-97</span></a>
                                                </div>
                                                <div class="col-auto col">
                                                    <div class="row row-social-icons-list">
                                                        <div class="col-auto col">
                                        ...
                                        <div class="pt-10">
                                            <div class="color-gray semibold">Подпись для телефона 2</div>
                                            <div class="row align-items-center sm-gutters">
                                                <div class="col-auto col">
                                                    <a href="" class="color-black nul semibold"><span class="dashed dash">+375 (29) 234-07-97</span></a>
                                                </div>
                                                <div class="col-auto col">
                                                    <div class="row row-social-icons-list">
                                                        <div class="col-auto col">
                                        ...
                                        <div class="pt-10">
                                            <div class="color-gray semibold">Подпись для телефона 3</div>
                                            <div class="row align-items-center sm-gutters">
                                                <div class="col-auto col">
                                                    <a href="" class="color-black nul semibold"><span class="dashed dash">+375 (29) 345-07-97</span></a>
                                                </div>
                                                <div class="col-auto col">
                                                    <div class="row row-social-icons-list">
                                                    </div>
                                        ...
                                        <div class="pt-10">
                                            <a href="" class="color-orange nul"><span class="dashed dash">info@perf.by</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
