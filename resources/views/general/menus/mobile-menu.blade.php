        ...
        <div class="mobile-menu-body">
            <div class="w-mobile-menu-group-list">
                <div class="w-mobile-menu-group-list-item">
                    ...
                    <ul class="ul-mobile-menu default mt-10">
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">О магазине</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Доставка</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Оплата</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Акции и скидки</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Новости</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Контакты</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Бензорезы</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Электрические резчики</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Цепные бензорезы</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Аксессуары и принадлежности</a></li>
                        <li class="li-mobile-menu"><a href="" class="mobile-menu__link">Оснастка для бензоинструмента</a></li>
                    </ul>
                </div>
                    ...
                    <div class="w-mobile-menu-offset-item">
                        <div class="pb-10">
                            <div class="w-icon-left location">
                                ...
                                <div class="text">Самовывоз: Минск, Меньковский тракт 2, офис 45</div>
                            </div>
                        </div>
                        <div class="pb-10">
                            <div class="w-icon-left time">
                                ...
                                <div class="text">пн.-пт. 8.30 — 17.30 (заезд до 17.00), сб. 9.00-14.00</div>
                            </div>
                        </div>
                    </div>
                </div>
