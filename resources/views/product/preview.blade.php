                ...
                <div class="w-name md-pt-10 pt-5 pb-10">
                    <div class="w-price-group">
                        <div class="w-price">
                            ...
                            <div class="w-price">
                                @if ($product->price)
                                    <div class="_h5 bold">{{ format_price($product->price) }} <span class="_h7">{{ $product->category?->measure ? 'BYN/' . $page->category->measure : 'BYN' }}</span></div>
                                @else
                    ...
                    @if ($product->price > 0 && $product->balance > 0)
                        <div class="row row-controlls sm-gutters">
                            ...
                            <div class="col-btn col-12 col pb-5">
                                <button class="button to-cart-btn {{ $inCart ? 'btn-to-cart _active' : '_js-add-to-cart' }} block row align-items-center justify-content-center sm-gutters">
                                    <div class="col-auto col">
                                    ...
                                    <div class="col-auto col">{{ $inCart ? 'В корзине' : 'В корзину' }}</div>
                                </button>
                            </div>
                        </div>
                    @endif
