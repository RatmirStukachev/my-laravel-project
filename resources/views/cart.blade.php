...
@section('content')
    ...
    <section class="s-line s-cart-page s-gray-bg">
        <div class="container pt-20 pb-60">
            ...
            <div class="row row-cart-page lg-md-gutters sm-gutters">
                        ...
                        <div class="frame">
                            <div class="row justify-content-sm-end justify-content-start">
                                <div class="col-auto sm-pt-15">
                                    <div class="color-gray">2 товара</div>
                                </div>
                            </div>
                            <div class="pt-15">
                                <hr>
                            ...
                            <div class="w-cart-list-item pt-20">
                                <div class="row row-cart-list-item md-gutters">
                                    <div class="col-image col">
                                        <div class="w-image">
                                            <div class="image">
                                                <a href="" class="block__link image__link">
                                                    <img src="assets/content/product-image001.jpg" class="img block"/>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="w-mobile-content-right-offset w-mobile-content-min-height">
                                                    <div class="row align-items-center md-gutters">
                                                        <div class="col-auto mb-5">
                                                            <div class="color-gray">Код T82172</div>
                                                        </div>
                                                        <div class="col-auto">
                                                    ...
                                                    <div class="title _h6 semibold mb-10"><a href="" class="name__link color-black nul">Пильный диск SHYLD по металлу твердосплавный 355x25,4 мм, 90 зубьев</a></div>
                                            ...
                                            <div class="col-price col mb-10">
                                                <div class="w-price-group">
                                                    <div class="w-price">
                                                        ...
                                                        <div class="w-price">
                                                            <div class="_h5 static bold">120,57 <span class="_h7">BYN/шт.</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row row-cart-list-item md-gutters">
                                    <div class="col-image col">
                                        <div class="w-image">
                                            <div class="image">
                                                <a href="" class="block__link image__link">
                                                    <img src="https://place-hold.it/130x130" class="img block"/>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row row-content md-gutters align-items-center justify-content-sm-between justify-content-start">
                                            <div class="col-name col">
                                                <div class="w-mobile-content-right-offset w-mobile-content-min-height">
                                                    ...
                                                    <div class="title _h6 semibold mb-10"><a href="" class="name__link color-black nul">Пильный диск</a></div>
                                                </div>
                                            </div>
                                            <div class="col-pcs col mb-10">
                                                <div class="_js-pcscontrolls pcscontrolls">
